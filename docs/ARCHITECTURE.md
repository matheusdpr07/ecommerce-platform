...
- O encaixe da roda percorre a distancia entre capitulos em uma animacao curta com aceleracao e desaceleracao; o bloqueio termina junto da animacao e da inercia do gesto, atua somente entre capitulos e libera a rolagem nos extremos; toque, teclado e movimento reduzido continuam no fluxo nativo
